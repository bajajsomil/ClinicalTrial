...
resource asp_frontend 'Microsoft.Web/serverfarms@2022-09-01' = {
  name: 'clinical-trial-ui-asp1236546'
  location: location
  sku: {
    name: 'B2'
  }
